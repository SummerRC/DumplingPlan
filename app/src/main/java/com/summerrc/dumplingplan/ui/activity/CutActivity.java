...
public class CutActivity extends Activity {
    ...
    private void initView() {
        ...
        final SimpleDraweeView sdv_soho_cut = (SimpleDraweeView) findViewById(R.id.sdv_soho_cut);
                    ...
                    sdv_soho_cut.setOnClickListener(new PlayAnimClickListener(anim, handler, 4000,
                            new PlayAnimClickListener.AnimStopCallBack() {
                                ...
                                public void afterAnimStop() {
                                    UIHelper.openSkinActivity(CutActivity.this);
                                }
                            }));
                }
            }
        ...
        Uri uri = Uri.parse("res://com.summerrc.dumplingplan/" + R.mipmap.soho_cut_gif);
        ...
        /** 设置Controller */
        sdv_soho_cut.setController(controller);
    }
