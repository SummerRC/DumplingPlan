...
public class PutActivity extends Activity {
    ...
    private void initView() {
        ...
        final SimpleDraweeView sdv_soho_put = (SimpleDraweeView) findViewById(R.id.sdv_soho_put);
        ControllerListener controllerListener = new BaseControllerListener<ImageInfo>() {
            @Override
            public void onFinalImageSet(String id, @Nullable ImageInfo imageInfo, @Nullable Animatable anim) {
                if (anim != null) {
                    sdv_soho_put.setOnClickListener(new PlayAnimClickListener(anim, handler, 2200,
                            new PlayAnimClickListener.AnimStopCallBack() {
                                @Override
                                public void afterAnimStop() {
                                    UIHelper.openShakeActivity(PutActivity.this);
                                }
                            }));
                }
            }
        ...
        Uri uri = Uri.parse("res://com.summerrc.dumplingplan/" + R.mipmap.soho_put_gif);
        ...
        /** 设置Controller */
        sdv_soho_put.setController(controller);
        setBackground();
        setVisible();
